              ...
              <div className="flex flex-wrap mb-12 text-left">
                <div className="w-full p-6 mx-auto lg:w-1/3">
                  <div className="p-4 lg:p-8 rounded-xl bg-blueGray-50">
                    ...
                    <Link href="apps/lspd" className="text-blue-600 inline-flex items-center mt-4 font-semibold lg:mb-0 hover:text-black" title="apply now">Apply now » </Link>
                  </div>
                </div>
                <div className="w-full p-6 mx-auto lg:w-1/3">
                  <div className="p-4 lg:p-8 rounded-xl bg-blueGray-50">
                    <Image className="object-cover object-center w-full mb-8 lg:h-48 md:h-36 rounded-xl" src="https://hamy.fileglass.com/370ff.webp" width="720" height="400" alt="blog"/>
                ...
                <div className="w-full p-6 mx-auto lg:w-1/3">
                  <div className="p-4 lg:p-8 rounded-xl bg-blueGray-50">
                    <Image className="object-cover object-center w-full mb-8 lg:h-48 md:h-36 rounded-xl" src="https://hamy.fileglass.com/h240a.webp" width="720" height="400" alt="blog"/>
